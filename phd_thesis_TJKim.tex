...
\usepackage{subfig}		% for adding several figures in a figure environment
...
\title{{\LARGE  낸드 플래시 저장장치의 성능 및 \\ 수명 향상을 위한 프로그램 컨텍스트 기반 \\ 계층 교차 최적화 기법}}
\engtitle{{\Large Program Context based Cross-Layer Optimization \\ Techniques for Improving Performance and Lifetime \\ of NAND Flash-Based Storage Devices}}
%\engtitle{{\Large Lifetime Improvement Techniques for \\ NAND Flash-Based Storage Devices \\ Based on Program Contexts }}
...
\input{ProgramContext.tex}
%\input{PCstream_rocksDB.tex}
\input{PCstream.tex}
\input{Finededup.tex}
